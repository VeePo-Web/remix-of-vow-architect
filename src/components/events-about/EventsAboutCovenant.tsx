            ...
            <div className="relative text-center pt-8 border-t border-border/20">
              ...
              <div className="relative h-16 mb-4 flex items-center justify-center">
                <svg viewBox="0 0 200 50" className="w-48 h-auto" style={{ overflow: "visible" }}>
                  <path d="M8,30 C25,15 40,40 65,28 S95,18 120,32 S155,22 180,35 Q190,38 195,32" fill="none" stroke="hsl(var(--foreground))" strokeWidth="1.5" strokeLinecap="round" style={{ strokeDasharray: 300, strokeDashoffset: signatureDrawn ? 0 : 300, transition: "stroke-dashoffset 1s ease-out" }} />
                </svg>
              </div>
              ...
              <p className={cn("text-xs uppercase tracking-[0.2em] text-muted-foreground mt-1 transition-all duration-700", signatureDrawn ? "opacity-100" : "opacity-0")} style={{ transitionDelay: "200ms" }}>Private Event Pianist</p>
            </div>
          </div>
        </div>
      </div>
