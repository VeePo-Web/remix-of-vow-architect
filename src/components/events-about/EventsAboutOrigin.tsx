    ...
    >
      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-5 gap-12 max-w-6xl mx-auto items-center">
          {/* Image — flipped order */}
          <div
            className={cn("md:col-span-3 relative transition-all duration-1000 rounded-sm order-2 md:order-1", isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}
          ...
          <div className="md:col-span-2 space-y-8 order-1 md:order-2">
            ...
            <div className={cn("transition-all duration-700", isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4")}>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs uppercase tracking-[0.3em]" style={{ color: "hsl(var(--muted-foreground))" }}>THE ROOM</p>
