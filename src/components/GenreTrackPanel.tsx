  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `inset 0 1px 0 hsl(var(--foreground) / 0.10), 0 16px 60px hsl(var(--rich-black) / 0.4), 0 0 20px hsl(var(--vow-yellow) / 0.04)${isPlaying ? ", inset 0 0 40px hsl(var(--vow-yellow) / 0.03)" : ""}`,
        opacity: 0,
    ...
    >
      ...
      <div className="px-5 pt-4 pb-3" style={{ borderBottom: "1px solid hsl(var(--vow-yellow) / 0.06)" }}>
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs uppercase tracking-[0.15em] text-foreground opacity-60 font-mono tabular-nums">
