    ...
    <section className="section-padding">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="mb-6">Your ceremony-audio plan begins with a file</h2>
          <div className="chapter-rule mx-auto mb-8" />
          
          <p className="lead text-muted-foreground mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/contact">
              <Button size="lg" className="hover-scale min-w-[240px]">
                <Calendar size={18} className="mr-2" />
                Hold my date & get a custom SPL plan
              </Button>
            </Link>
            
            <Button size="lg" variant="outline" className="hover-scale min-w-[240px]">
