  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: isActive
          ? "0 6px 30px hsl(var(--rich-black) / 0.35), 0 0 30px hsl(var(--vow-yellow) / 0.12), inset 0 1px 0 hsl(var(--foreground) / 0.06)"
          : "0 6px 30px hsl(var(--rich-black) / 0.35), inset 0 1px 0 hsl(var(--foreground) / 0.06)",
      }}
