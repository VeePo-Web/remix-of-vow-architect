        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {tiers.map((t, i) => (
            <div
              key={t.name}
              className={cn(
                "relative rounded-2xl p-8 transition-all duration-[500ms] flex flex-col",
                t.isSelected
                  ? "border-2 border-[hsl(var(--vow-yellow)/0.30)] hover:border-[hsl(var(--vow-yellow)/0.50)]"
                  : "border border-[hsl(var(--vow-yellow)/0.06)] hover:border-[hsl(var(--vow-yellow)/0.15)]",
                "hover:-translate-y-1",
