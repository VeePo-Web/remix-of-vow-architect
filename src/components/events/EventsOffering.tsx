          ...
          {tiers.map((t, i) => (
            <div
              ...
              className={cn(
                ...
                t.isSelected
                  ? "border-2 border-[hsl(var(--vow-yellow)/0.30)] hover:border-[hsl(var(--vow-yellow)/0.50)] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_0_40px_hsl(var(--vow-yellow)/0.06)]"
                  : "border border-[hsl(var(--vow-yellow)/0.06)] hover:border-[hsl(var(--vow-yellow)/0.15)] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
                "hover:-translate-y-1",
