...
const fears = [
  {
    ...
    resolution:
      "You did not quit. You were taught by someone who measured your progress by their timeline instead of yours. The guilt you carry about stopping belongs to the method that mistook speed for progress. There is no timeline here. There is only your pace, your sound, and my patience.",
    underlineWord: "pace",
  },
  {
