...
const stories = [
  {
    narrative:
      "Margaret came to the bench at 52, apologizing before her hands even touched the keys. 'I should have started decades ago,' she said. Six months later, she played a piece for her husband on their anniversary — not perfectly, but honestly. She called it the first gift she ever made with her own hands.",
    quote: "The first gift I ever made with my own hands.",
    quoteUnderline: "hands",
  },
  {
    narrative:
      "David had taken lessons as a child and quit at 14. Twenty years of silence. When he returned to the bench, his hands remembered more than he expected — and less than he hoped. But the sound was different now. It carried something it could not carry at 14: the weight of everything he had lived since.",
    ...
    >
      ...
      <div className="relative z-10 max-w-[640px] mx-auto">
        ...
        <div ref={closingRef}>
          ...
          >
            — every story began at the bench
          </span>
        </div>
      </div>
