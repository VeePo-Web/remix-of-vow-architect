...
const pillars = [
  ...
  },
  {
    ...
    description:
      "The piano is not a skill to acquire. It is a voice waiting to be found. Technique serves expression, never the reverse — every scale, every exercise exists only to unlock what you want to say.",
    underlineWord: "voice",
  },
  {
    numeral: "III",
    ...
    description:
      "When your hands know the instrument deeply enough, they stop translating and start saying what you mean. That is fluency. And fluency is freedom — the freedom to say anything the moment asks for.",
  ...
  },
  {
    ...
    title: "No Graduation",
    description:
      "There is no final lesson. Only deepening. The mentorship deepens as you do — measured in years, not semesters.",
